    ...
    if (!currentItem || activeItems.length === 0) {
      return (
        <div className="flex flex-col items-center justify-center h-full">
          <h2 className="text-2xl font-semibold mb-4">No active content</h2>
          <p className="text-muted-foreground">Add and activate content in the admin dashboard</p>
        </div>
      );
    }
      ...
      if (currentItem.videoSource === 'youtube') {
        ...
        return (
          <iframe
            ...
            allowFullScreen
            // Allow the iframe to communicate with the current doc
